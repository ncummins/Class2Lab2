 ...
 * @author ncummins
 */
@WebServlet(name = "Pager", urlPatterns = {"/Pager"})
public class Pager extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Pager</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Pager at " + request.getContextPath() + "</h1>");
            out.println("<table>" + new Date());
